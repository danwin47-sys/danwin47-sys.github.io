...
// ===================================
console.log('%c👋 嗨！開發者朋友！', 'font-size: 20px; font-weight: bold; color: #6366f1;');
console.log('%c如果你對這個網站的程式碼感興趣，歡迎查看我的 GitHub！', 'font-size: 14px; color: #475569;');
console.log('%c🚀 讓我們一起創造美好的網頁體驗！', 'font-size: 14px; color: #14b8a6;');
